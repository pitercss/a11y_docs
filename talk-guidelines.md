...
В заявке на выступление на митапе мы просим написать **дерево тезисов** или **timeline**. По дереву тезисов должно быть легко понять примерную структуру доклада и основные идеи.
